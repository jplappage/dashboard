...
const FILMS = [
  ...
  // actual date (release window + films usually drop on a Tuesday) — see note.
  {
    ...
    year: 2026,
    slug: 'pressure-2026',
    poster: 'https://a.ltrbxd.com/resized/film-poster/1/1/9/8/9/7/2/1198972-pressure-2026-0-600-0-900-crop.jpg?v=38a01c694d',
    vodDate: '2026-06-16',
    platform: 'Digital',
    estimated: false,
    imdbRating: 7.3,
  ...
  },
  {
    ...
    platform: null,
    estimated: true,
    note: 'Black Bear crime thriller (McConaughey) · SXSW 2025 · US cinemas 14 Aug 2026 · digital est. 15 Sep 2026 (WhenToStream — unconfirmed, pre-order only)',
    imdbRating: 7.3,
    runtime: 130,
  },
  {
